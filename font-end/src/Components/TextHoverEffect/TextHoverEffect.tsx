...
export const TextHoverEffect = ({
    ...
    return (
        ...
        <text
            ...
            style={{ opacity: hovered ? 0.7 : 0, position: "relative" }}
        >
            { text }
        </text>
        <text
        ...
        <text
            ...
            y="70%"
            strokeWidth="0.3"
            className="font-[helvetica] font-bold stroke-neutral-200 dark:stroke-neutral-800 fill-transparent text-2xl text-blue-600 "
